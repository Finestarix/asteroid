...
export default function ManageUserPage() {
    ...
    useEffect(() => {
        const handleViewUser = async () => {
            ...
            const userFetch = await fetch("/api/user/getUsers", {
                method: "POST",
                headers: {
            ...
            const userData: ViewUsersData = await userFetch.json();
    ...
    const handleChangePasswordUser = async (id: number) => {
        setShowLoading(true);

        const updatePasswordUserFetch = await fetch("/api/user/updateResetPasswordUser", {
            method: "POST",
            headers: {
                authorization: decryptData(getSessionToken())
            },
